import { z } from "zod";
import { pgTable, varchar, integer, timestamp, text, uniqueIndex, index, jsonb } from "drizzle-orm/pg-core";
import { createInsertSchema } from "drizzle-zod";
import { sql } from "drizzle-orm";

// Phone System Providers - Top Enterprise VOIP Solutions
export const phoneProviders = ["RingCentral", "Vonage", "Nextiva", "8x8", "Zoom Phone", "Manual"] as const;
...
// Auth tables - required for Replit Auth integration
