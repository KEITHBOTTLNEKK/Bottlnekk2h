        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 max-w-3xl mx-auto">
          {phoneProviders.map((provider) => (
            <button
              ...
              className="group relative px-8 py-12 border-2 border-white/20 rounded-lg transition-all duration-300 hover:border-white hover:bg-white/5 hover:scale-105"
              data-testid={`button-provider-${provider.toLowerCase()}`}
            >
              <div className="flex flex-col items-center justify-center space-y-4">
                <div className="w-16 h-16 rounded-full border-2 border-white/30 flex items-center justify-center group-hover:border-white transition-colors duration-300">
                  <div className="w-8 h-8 rounded-full bg-white/20 group-hover:bg-white/40 transition-colors duration-300" />
                </div>
